...
import { AgentSukiPayload, FactEntry } from '@jhos/shared';
 ...
 */
function unpackBullets(prefix: string, bullets: FactEntry[] | undefined): Record<string, string> {
 ...
 */
export function renderResume(templateBuffer: Buffer, payload: AgentSukiPayload): Buffer {
